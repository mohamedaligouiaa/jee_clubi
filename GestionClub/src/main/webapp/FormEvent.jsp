            ...
            <option value="Other">Other</option>
								...
								<section>
									...
									<div class="form-wrap max-width-600 mx-auto">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">ID du Club :</label>
											<div class="col-sm-8">
...
$(".tab-wizard2").steps({
    ...
    onFinished: function(event, currentIndex) {
        ...
        let clubId = $("input[name='club_id']").val();
        if (clubId && isNaN(clubId)) {
            isValid = false;
            $("input[name='club_id']").addClass("error");
            $("input[name='club_id']").next(".error-message").text("L'ID du club doit être un nombre").show();
        }
